...
aerial.buildType = () => extend(Drill.DrillBuild, aerial, {
  draw(){    
    ...
    Draw.rect(aerial.propellorRegion, this.x, this.y, this.timeDrilled * this.rotateSpeed);
    Draw.rect(aerial.rotateRegion, this.x, this.y, this.timeDrilled * this.rotateSpeed);
