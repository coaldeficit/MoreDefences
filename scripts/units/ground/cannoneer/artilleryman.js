...
var upgrade = new Seq([Vars.content.getByName(ContentType.unit, "more-defences-ivyx"), Vars.content.getByName(ContentType.unit, "more-defences-artilleryman-mech")]);
